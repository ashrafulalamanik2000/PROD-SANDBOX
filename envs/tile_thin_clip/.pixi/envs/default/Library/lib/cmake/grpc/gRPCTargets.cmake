...
foreach(_cmake_expected_target IN ITEMS gRPC::address_sorting gRPC::gpr gRPC::grpc gRPC::grpc++ gRPC::grpc++_alts gRPC::grpc++_error_details gRPC::grpc++_reflection gRPC::grpc_authorization_provider gRPC::grpc_plugin_support gRPC::grpcpp_channelz)
...
set_target_properties(gRPC::grpc++ PROPERTIES
  ...
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;ws2_32;crypt32;absl::dynamic_annotations;absl::prefetch;absl::layout;absl::absl_check;absl::absl_log;absl::charset;absl::strings_internal;gRPC::grpc;protobuf::libprotobuf"
)
...
set_target_properties(gRPC::grpc_authorization_provider PROPERTIES
  INTERFACE_COMPILE_FEATURES "cxx_std_17"
  INTERFACE_INCLUDE_DIRECTORIES "${_IMPORT_PREFIX}/include"
  INTERFACE_LINK_LIBRARIES "protobuf::libupb;ws2_32;crypt32;re2::re2;ZLIB::ZLIB;absl::no_destructor;absl::btree;absl::flat_hash_map;absl::flat_hash_set;absl::inlined_vector;absl::node_hash_map;absl::function_ref;absl::hash;absl::type_traits;absl::statusor;absl::string_view;absl::span;absl::utility;c-ares::cares;gRPC::gpr;gRPC::address_sorting"
)
