...
set_target_properties(Azure::azure-core PROPERTIES
  IMPORTED_IMPLIB_RELEASE "${_IMPORT_PREFIX}/lib/azure-core.lib"
  IMPORTED_LOCATION_RELEASE "${_IMPORT_PREFIX}/bin/azure-core.dll"
  )

list(APPEND _cmake_import_check_targets Azure::azure-core )
list(APPEND _cmake_import_check_files_for_Azure::azure-core "${_IMPORT_PREFIX}/lib/azure-core.lib" "${_IMPORT_PREFIX}/bin/azure-core.dll" )
