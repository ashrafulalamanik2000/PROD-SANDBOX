...
/* experimental -- keep these declared even when DEPRECATED_OR_OBSOLETE_CODE_REMOVED
 * is set; the frontend (and the exported libmp3lame symbols) still use them,
 * matching the unguarded utf16/utf8 variants below. */
