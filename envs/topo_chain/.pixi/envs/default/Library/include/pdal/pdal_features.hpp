...
const int pdalVersionMinor { 10 };
const int pdalVersionPatch { 1 };
const std::string pdalVersion { "2.10.1" };
const std::string pdalSha { "Release" };

} // namespace pdal

#define PDAL_PLUGIN_INSTALL_PATH "bin"
/*
